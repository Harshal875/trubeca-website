    ...
    <>
        ...
        <div className="container-main py-10 md:py-16">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16">
            ...
            <Reveal direction="left">
              <div className="aspect-square bg-gradient-to-br from-gray-50 to-brand-50/30 rounded-3xl flex items-center justify-center lg:sticky lg:top-28 border border-gray-100">
            ...
            <Reveal direction="right" delay={0.1}>
              <div>
                <span className="inline-block px-3 py-1 text-[10px] uppercase tracking-wider font-semibold bg-navy-900/80 text-white rounded-full">
                  {product.category.replace(/-/g, " ")}
                </span>
                <h1 className="mt-4 text-display-sm md:text-heading font-bold text-navy-900">
                  {product.brandName}
                </h1>
        ...
        <section className="section-padding bg-gray-50/50">
          <div className="container-main">
            <div className="flex items-center justify-between mb-8">
              ...
              <Link
                href="/products"
                className="text-sm text-brand-500 font-semibold hover:text-brand-600 inline-flex items-center gap-1 group"
              >
      ...
      <div className="border-t border-gray-100">
        <div className="container-main py-6">
          <Link
            href="/products"
            className="text-sm text-brand-500 font-semibold hover:text-brand-600 inline-flex items-center gap-1.5 group"
          >
